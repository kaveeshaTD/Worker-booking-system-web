...
{
    public partial class BOOKGardenMaker : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    get_gardenMakerAdmin();
                    foreach (DataControlField column in grdgardenmaker.Columns)
                    {
        ...
        private void get_gardenMakerData()
        {
            ...
            da.Fill(ds);
            grdgardenmaker.DataSource = ds;
            grdgardenmaker.DataBind();
            con.Close();
        }

        //for admin data view
        private void get_gardenMakerAdmin()
        {
            //string current_location = HttpContext.Current.Session["U_location"] as string;
            string type = "Garden Cleaner";
            SqlConnection con = dbcon.getDbConnection();
        ...
        protected void grdgardenmaker_RowCommand(object sender, GridViewCommandEventArgs e)
        {
        ...
        protected void grdgardenmaker_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
