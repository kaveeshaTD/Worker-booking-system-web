<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookmayson.aspx.cs" Inherits="ControlSys.bookmayson" MasterPageFile="~/NavBar.Master" %>

<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ID="contentone">
     <style>
            body
    {
        font-family: Arial;
    ...
    .GridPager span
    {
     ...
     <asp:GridView ID="grdmayson" runat="server" CssClass="table container-lg mt-5" AutoGenerateColumns="false"
        DataKeyNames="Id"
        OnRowCommand="grdmayson_RowCommand"
         AllowPaging="true" PageSize="6"
         OnPageIndexChanging="grdmayson_PageIndexChanging">
        <Columns>
