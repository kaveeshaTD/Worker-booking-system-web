<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookPlumber.aspx.cs" Inherits="ControlSys.bookPlumber" MasterPageFile="~/NavBar.Master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ID="contone">
    ...
    .GridPager span
    {
     ...
     <asp:GridView ID="grdplumber" runat="server" CssClass="table container-lg mt-5" AutoGenerateColumns="false"
        DataKeyNames="Id"
        OnRowCommand="grdplumber_RowCommand"
         AllowPaging="true" PageSize="6"
         OnPageIndexChanging="grdplumber_PageIndexChanging">
        <Columns>
