...
{
    public partial class bookmayson : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    get_maysonDataAdmin();
                    foreach (DataControlField column in grdmayson.Columns)
                    {
        ...
        private void get_maysonData()
        {
            ...
            da.Fill(ds);
            grdmayson.DataSource = ds;
            grdmayson.DataBind();
            con.Close();
        }

        //get mayson data admin
        private void get_maysonDataAdmin()
        {
            //string current_location = HttpContext.Current.Session["U_location"] as string;
            string type = "Mason";
            SqlConnection con = dbcon.getDbConnection();
        ...
        protected void grdmayson_RowCommand(object sender, GridViewCommandEventArgs e)
        {
        ...
        protected void grdmayson_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            grdmayson.PageIndex = e.NewPageIndex;
            this.get_maysonData();
        }
    }
}