...
{
    public partial class bookPlumber : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    get_plumberAdmin();
                    foreach (DataControlField column in grdplumber.Columns)
                    {
        ...
        private void get_plumberData()
        {
            ...
            da.Fill(ds);
            grdplumber.DataSource = ds;
            grdplumber.DataBind();
            con.Close();
        }

        //for admin data view
        private void get_plumberAdmin()
        {
            //string current_location = HttpContext.Current.Session["U_location"] as string;
            string type = "plumber";
            SqlConnection con = dbcon.getDbConnection();
