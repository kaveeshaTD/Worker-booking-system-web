<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookpainter.aspx.cs" Inherits="ControlSys.bookpainter" MasterPageFile="~/NavBar.Master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ID="contone">
    ...
    .GridPager span
    {
     ...
     <asp:GridView ID="grdpainter" runat="server" CssClass="table container-lg mt-5" AutoGenerateColumns="false"
        DataKeyNames="Id"
        OnRowCommand="grdpainter_RowCommand"
         AllowPaging="true" PageSize="6"
         OnPageIndexChanging="grdpainter_PageIndexChanging">
        <Columns>
