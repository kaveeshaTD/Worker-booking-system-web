<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bookele.aspx.cs" Inherits="ControlSys.bookele" MasterPageFile="~/NavBar.Master" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ID="contentone">
    ...
    .GridPager span
    {
     ...
     <asp:GridView ID="grdelec" runat="server" CssClass="table container-lg mt-5" AutoGenerateColumns="false"
        DataKeyNames="Id"
        OnRowCommand="grdelec_RowCommand"
         AllowPaging="true" PageSize="6"
         OnPageIndexChanging="grdelec_PageIndexChanging">
        <Columns>
